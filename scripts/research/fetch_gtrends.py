...
in external_series. This measures what the PUBLIC is searching for — a different
lens from outlet-associated press tone or market prices.
...
Usage:  python -m scripts.research.fetch_gtrends
"""
